    ...
    Container(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Container(
              margin: EdgeInsets.fromLTRB(0, 0, 0, 224),
              child: Text(
                'Choose Weekly Notification',
            ...
            Container(
              margin: EdgeInsets.fromLTRB(0, 0, 29, 355),
              child: Text(
                'Day / Time',
                style: GoogleFonts.getFont(
                  'Roboto Condensed',
                                    ...
                                    children: [
                                      SizedBox(
                                        ...
                                        child: SvgPicture.asset(
                                          'assets/vectors/path_144_x2.svg',
                                        ),
                                      ),
                                      Positioned(
                                        left: 0,
                                        ...
                                        child: Container(
                                          ...
                                          child: SizedBox(
                                            ...
                                            height: 7,
                                            child: SvgPicture.asset(
                                              'assets/vectors/group_1056_x2.svg',
                                            ),
                                          ),
                                        ),
                                      ),
                                              ...
                                              children: [
                                                Container(
                                                  ...
                                                  child: SizedBox(
                                                    ...
                                                    height: 10,
                                                    child: SvgPicture.asset(
                                                      'assets/vectors/group_1156_x2.svg',
                                                    ),
                                                  ),
                                                ),
                                                Positioned(
