...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Container(
      ...
      child: Container(
        padding: EdgeInsets.fromLTRB(13, 47, 10, 0),
        child: Column(
          mainAxisAlignment: MainAxisAlignment.start,
          crossAxisAlignment: CrossAxisAlignment.center,
          children: [
            Container(
              margin: EdgeInsets.fromLTRB(0, 0, 3, 344),
              child: Text(
                'Home',
            ...
            Container(
              margin: EdgeInsets.fromLTRB(3, 0, 5, 345),
              child: Container(
                decoration: BoxDecoration(
                                    ...
                                    children: [
                                      SizedBox(
                                        ...
                                        child: SvgPicture.asset(
                                          'assets/vectors/path_141_x2.svg',
                                        ),
                                      ),
                                      Positioned(
                                        left: 0,
                                        ...
                                        child: Container(
                                          ...
                                          child: SizedBox(
                                            ...
                                            height: 7,
                                            child: SvgPicture.asset(
                                              'assets/vectors/group_1053_x2.svg',
                                            ),
                                          ),
                                        ),
                                      ),
                                              ...
                                              children: [
                                                Container(
                                                  ...
                                                  child: SizedBox(
                                                    ...
                                                    height: 10,
                                                    child: SvgPicture.asset(
                                                      'assets/vectors/group_1152_x2.svg',
                                                    ),
                                                  ),
                                                ),
                                                Positioned(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: SizedBox(
                                                      ...
                                                      height: 30,
                                                      child: SvgPicture.asset(
                                                        'assets/vectors/group_1174_x2.svg',
                                                      ),
                                                    ),
                                                  ),
                                                ),
