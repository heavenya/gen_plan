...
class SignupEmailConfirm extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    Container(
            padding: EdgeInsets.fromLTRB(20, 14.3, 14.7, 9),
            child: Column(
              mainAxisAlignment: MainAxisAlignment.start,
              crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                Container(
                  margin: EdgeInsets.fromLTRB(14.7, 0, 0, 20.7),
                  child: Row(
                ...
                Container(
                  margin: EdgeInsets.fromLTRB(0, 0, 5.3, 111),
                  child: Text(
                    'Gen Plan',
                    style: GoogleFonts.getFont(
                      'Varela Round',
                ...
                Container(
                  margin: EdgeInsets.fromLTRB(0, 0, 5.3, 52),
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.start,
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
                      ...
                      Container(
                        ...
                        Please check your mailbox and use provided 
                ...
                Container(
                  margin: EdgeInsets.fromLTRB(7, 0, 15.3, 236),
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                        ...
                        child: Container(
                          ...
                          child: Opacity(
                            ...
                            child: Container(
                              ...
                              child: Container(
                                padding: EdgeInsets.fromLTRB(2, 17, 0, 20),
                                child: Stack(
                                  clipBehavior: Clip.none,
                                  children: [
                                    Text(
