...
class OnboardingScreen1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Container(
      ...
      child: Container(
        padding: EdgeInsets.fromLTRB(1, 14, 0, 0),
        child: Column(
          mainAxisAlignment: MainAxisAlignment.start,
          crossAxisAlignment: CrossAxisAlignment.center,
          children: [
            Container(
              margin: EdgeInsets.fromLTRB(0, 0, 16, 89),
              child: Text(
                'Select Interests',
            ...
            Container(
              margin: EdgeInsets.fromLTRB(12, 0, 18, 57),
              child: Container(
                decoration: BoxDecoration(
                                      ...
                                      children: [
                                        SizedBox(
                                          ...
                                          child: SvgPicture.asset(
                                            'assets/vectors/path_148_x2.svg',
                                          ),
                                        ),
                                        Positioned(
                                          left: 0,
                                          ...
                                          child: Container(
                                            ...
                                            child: SizedBox(
                                              ...
                                              height: 7,
                                              child: SvgPicture.asset(
                                                'assets/vectors/group_1055_x2.svg',
                                              ),
                                            ),
                                          ),
                                        ),
                                                ...
                                                children: [
                                                  Container(
                                                    ...
                                                    child: SizedBox(
                                                      ...
                                                      height: 10,
                                                      child: SvgPicture.asset(
                                                        'assets/vectors/group_1153_x2.svg',
                                                      ),
                                                    ),
                                                  ),
                                                  Positioned(
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: SizedBox(
                                                        ...
                                                        height: 30,
                                                        child: SvgPicture.asset(
                                                          'assets/vectors/group_1177_x2.svg',
                                                        ),
                                                      ),
                                                    ),
                                                  ),
